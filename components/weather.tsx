...
export const Weather = ({ weatherData }: { weatherData: WeatherResponse }) => {
  return (
    <div className="col-span-9 bg-[#e4f0fe] rounded-l-4xl p-12 text-black flex flex-col gap-8 h-full">
      <div>
        <h3 className="text-lg font-medium">Welcome back, Guest!</h3>
        <h4>Checkout today&apos;s weather information</h4>
      </div>
      <div className="bg-white rounded-4xl px-8 p-6 flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="grid grid-cols-3 gap-10">
          <div className="rounded-4xl bg-white px-8 py-6 flex flex-col items-center gap-1">
